...
function AutocompleteItemContent({ option, seeds }: { option: AutocompleteItem; seeds: { name: string }[] }) {
    return (
        <div className="e-flex e-w-full e-flex-col e-items-start e-justify-between e-gap-1 e-px-4 e-py-1.5 e-text-xs">
            <span className="e-text-xs e-font-medium e-text-heavy-metal-300">
                {option.label}
                {option.generated && (
                    <Image
                        src={StarsIcon}
                        ...
                        height={16}
                        width={16}
                        className="e-ml-2 e-inline"
                    />
                )}
            </span>

            <span className="e-w-full e-break-all e-font-mono e-text-[11px] e-text-heavy-metal-400">
                {option.value || 'Enter all required arguments to generate PDA'}
            </span>

            {option.generated && option.value && (
                <div className="e-text-[10px] e-text-heavy-metal-500">
